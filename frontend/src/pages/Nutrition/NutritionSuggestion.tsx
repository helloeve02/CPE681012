  ...
  const extraAdvice = [
    {
      ...
      recommendation: {
        ...
        dialysis:
          "ควรรับประทานโปรตีนในแต่ละวัน เพิ่มมากกว่าคนปกติ คือ ประมาณ 1.2 – 1.5 กรัม/น้ำหนักตัว 1 กก./วัน เนื่องจากร่างกายสูญเสียโปรตีนไปบางส่วนจากกระบวนการฟอกไต",
      },
      note: "โปรตีนพบในอาหาร เช่น เนื้อสัตว์ ไก่ ปลา ไข่ นม และถั่วต่าง ๆ รวมถึงต้องระวังอาหารประเภทข้าว/แป้งที่ยังมีโปรตีนแฝงอีกด้วย",
      tips: null,
    },
    {
      id: "phosphorus-card",
